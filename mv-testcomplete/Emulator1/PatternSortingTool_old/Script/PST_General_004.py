#Author: Ha Le
#The test verify value will be kept although link is deleted if user click no button on dialog
...
def PST_General_004():
  ...
  Aliases.javaw.Dialog2.RootPane.null_layeredPane.null_contentPane.OptionPane.OptionPane_buttonArea.OptionPane_button.ClickButton()

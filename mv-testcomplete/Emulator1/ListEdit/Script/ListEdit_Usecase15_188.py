...
def ListEdit_Usecase15_188(): 
  ...
  Setup.Setup_LoadTool("Line Find")  
  Setup.Setup_LoadTool("List Edit")
  Setup.Setup_LEPanel("Setup")
  Setup.Setup_LEInput1("Line Segment", "Read", "None", "None")
  Setup.Setup_LELinkItem("Line Segment")

  Setup.Setup_LEInput2("Line Segment List", "Insert", "None")
  for i in range(0, 10):

...
Driver = DDT.ExcelDriver("../../TestSteps.xlsx", "TestSteps")
Driver1 = DDT.ExcelDriver("../../TestSteps.xlsx", "TestData")
Driver2 = DDT.ExcelDriver("../../TestSteps.xlsx", "ExpectedOutput")

def CheckInput1Pro():
  #The test perform check the input value in properties tab then compare with the value expected in excel sheet or .csv file
    if not "None" in Driver1.Value[34]:
      if(Driver2.Value[39]=="Image List" or Driver2.Value[39]=="Integer List" or Driver2.Value[39]=="Line Segment List" or Driver2.Value[39]=="Origin List" or Driver2.Value[39]=="Point List" or Driver2.Value[39]=="Real List" or Driver2.Value[39]=="Rectangle List" or Driver2.Value[39]=="Blob List" or Driver2.Value[39]=="Boolean List" or Driver2.Value[39]=="String List" or Driver2.Value[39]=="Calibration Info List" or Driver2.Value[39]=="OCR Font Library List" or Driver2.Value[39]=="OCR Field Definition List" or Driver2.Value[39]=="OCR Space Model List" or Driver2.Value[39]=="OCRVerificationParams List" or Driver2.Value[39]=="Pattern Model List"):
        check = Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "C"]
      elif(Driver2.Value[39]=="Calibration Info" or Driver2.Value[39]=="OCR Font Library" or Driver2.Value[39]=="OCR Field Definition" or Driver2.Value[39]=="OCRVerificationParams" ):
        check = Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "C"]
      else:
        check = Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "C"]
      if check ==Driver2.Value[39]=="Image" or check ==Driver2.Value[39]=="Integer" or check ==Driver2.Value[39]=="Line Segment" or check ==Driver2.Value[39]=="Origin" or check ==Driver2.Value[39]=="Point" or check ==Driver2.Value[39]=="Real" or check ==Driver2.Value[39]=="Rectangle" or check ==Driver2.Value[39]=="String" or check ==Driver2.Value[39]=="Blob" or check ==Driver2.Value[39]=="Boolean" or Driver2.Value[39]=="String" or Driver2.Value[39]=="Calibration Info" or Driver2.Value[39]=="OCR Font Library" or Driver2.Value[39]=="OCR Field Definition" or Driver2.Value[39]=="OCR Space Model" or Driver2.Value[39]=="OCRVerificationParams" or Driver2.Value[39]=="Pattern Model":
  
          Log.Checkpoint("Check Input1 in properties for " + Driver2.Value[1] + " Pass")         
          a = 0           
      elif check==Driver2.Value[39]=="Image List":
          a= Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "E"].imageList_.elementCount
                    
      elif check=="Integer List"==Driver2.Value[39]:
          a= Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "E"].integerList_.elementCount
      elif check=="Line Segment List"==Driver2.Value[39]:
           
        a= Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "E"].lineSegmentList_.elementCount
      elif check=="Origin List"==Driver2.Value[39]: 
        a= Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "E"].originList_.elementCount
      elif check=="Point List"==Driver2.Value[39]: 
 
        a= Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "E"].pointList_.elementCount
      elif check=="Real List"==Driver2.Value[39]:   

        a= Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "E"].realList_.elementCount
      elif check=="Rectangle List"==Driver2.Value[39]: 
 
        a= Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "E"].rectangleList_.elementCount
      elif check=="String List"==Driver2.Value[39]: 
        a= Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "E"].stringList_.elementCount
          
      elif check=="Blob List"==Driver2.Value[39]:   

        a= Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "E"].blobList_.elementCount
      elif check=="Boolean List"==Driver2.Value[39]:    
        a= Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "E"].booleanList_.elementCount
      
      elif check=="Calibration Info List"==Driver2.Value[39]:   

        a= Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "E"].calibrationInfoList_.elementCount
      elif check=="OCR Font Library List"==Driver2.Value[39]: 
 
        a= Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "E"].ocrTrainingSetList_.elementCount
      elif check=="OCR Field Definition List"==Driver2.Value[39]: 
        a= Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "E"].ocrFieldDefinitionList_.elementCount
          
      elif check=="OCR Space Model List"==Driver2.Value[39]:   

        a= Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "E"].ocrspaceModelList_.elementCount
      elif check=="OCRVerificationParams List"==Driver2.Value[39]:    
        a= Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "E"].ocrVerificationParamsList_.elementCount
      elif check=="Pattern Model List"==Driver2.Value[39]:    
        a= Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane2.Panel.PropertiesScrollPane.Viewport.PropertyTable.wValue[3, "E"].ShapeFindModelList_.elementCount
 
      
      else:
        Log.Message("not found")
      if a == int(Driver2.Value[40]):
        Log.Checkpoint("Check Input1 in properties for " + Driver2.Value[1] + " Pass")
      else:
        Log.Error("Check Input1 in properties for " + Driver2.Value[1] + " Fail with actual value: " + str(a))
          

    
def CheckInput1():
  #The test perform check the input value in Setup tab then compare with the value expected in excel sheet or .csv file
  if not "None" in Driver1.Value[14]:
    aqObject.CheckProperty(Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane.Panel.Setup.BaseSetupPanel_1.ScrollPane.Viewport.Panel.Panel.ToolSetupCardPanel.ListEditSetup_ListDataPanel.Panel.Panel3.Panel.Panel.Panel.Panel.Label, "Text", cmpEqual, str(Driver2.Value[2]).strip('""'))

  else:
    Log.Message("Not in checkpoint check")
    
def CheckInput1Detail():
  ...
  if Driver1.Value[18] == "CheckInput1Detail":
    ...
    if Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane.SplitPane.DetailComponent.DetailComponent_1.DetailComponent_BottomComponent_.PropertiesTabbedPane.Panel.Setup.BaseSetupPanel_1.ScrollPane.Viewport.Panel.Panel.ToolSetupCardPanel.ListEditSetup_ListDataPanel.Panel.Panel3.Panel.Panel.Panel.Panel2.Panel.ScrollPane.Viewport.ListEditSetup_PortDataTable.Exists:
      for i in range(0, count1):  
       ...
       if str(count.strip()) == "1":
          ...
          Log.Error("Check input 1 for " + Driver2.Value[1] + " Fail with actual value" + str(count))
  else:
    Log.Message("Not in checkpoint check")  
...
def CheckOutput2Pro():
  ...
  if not "None" in Driver1.Value[36]:
        ...
        if check ==Driver2.Value[43]=="Image" or check ==Driver2.Value[43]=="Integer" or check ==Driver2.Value[43]=="Line Segment" or check ==Driver2.Value[43]=="Origin" or check ==Driver2.Value[43]=="Point" or check ==Driver2.Value[43]=="Real" or check ==Driver2.Value[43]=="Rectangle" or check ==Driver2.Value[43]=="String" or check ==Driver2.Value[43]=="Blob" or check ==Driver2.Value[43]=="Boolean" or Driver2.Value[43]=="Calibration Info" or Driver2.Value[43]=="OCR Font Library" or Driver2.Value[43]=="OCR Field Definition" or Driver2.Value[43]=="OCR Space Model" or Driver2.Value[43]=="OCRVerificationParams" or Driver2.Value[43]=="Pattern Model":
          Log.Message(Driver2.Value[43]+"-value check")
  ...
  #map testcase and test data from the excel sheet/csv file and excute
    ...
    for i in range(2, Driver.ColumnCount):
        ...
        if Driver.Value[i] == "Setup_loadVPM":
          Setup.Setup_loadVPM()
        if Driver.Value[i] == "Setup_LoadImage":
          Setup.Setup_LoadImage(Driver1.Value[2])
        ...
        if Driver.Value[i] == "Setup_AdvOCR":
          Setup.Setup_AdvOCR()
          
        if Driver.Value[i] == "Setup_LEOrigin":
          Setup.Setup_LEOrigin() 
          
        if Driver.Value[i] == "Setup_LoadPatternFind":
          Setup.Setup_LoadPatternFind()
                 
        if Driver.Value[i] == "Setup_PFTrainROIPanel":
          Setup.Setup_PFTrainROIPanel() 
          
        if Driver.Value[i] == "Setup_PFTrainButton":
          Setup.Setup_PFTrainButton()                 
          
        if Driver.Value[i] == "Setup_LoadTool1":
          a = Driver1.Value[3]
   
          Setup.Setup_LoadTool(a)
        if Driver.Value[i] == "Setup_LoadTool2":
        
          b = Driver1.Value[4]
     
          Setup.Setup_LoadTool(b)
        if Driver.Value[i] == "Setup_LoadTool":
          a = Driver1.Value[3]
          b = Driver1.Value[4]
          Setup.Setup_LoadTool(a)  
          Setup.Setup_LoadTool(b) 
          
        if Driver.Value[i] == "Setup_Calibration":
          Setup.Setup_Calibration()

        
        if Driver.Value[i] == "Setup_PFCreateModel":
          Setup.Setup_PFCreateModel(Driver1.Value[32], Driver1.Value[33])

        if Driver.Value[i] == "Setup_CaCalibratePanel":
          Setup.Setup_CaCalibratePanel()
         
        if Driver.Value[i] == "Setup_VPMUnloadProgram":
          Setup.Setup_VPMUnloadProgram()
                  
        if Driver.Value[i] == "Setup_LEPanel":
          Setup.Setup_LEPanel(Driver1.Value[5])
          
        if Driver.Value[i] == "Setup_VPMPropertiesTab":
          Setup.Setup_VPMPropertiesTab()
          
        if Driver.Value[i] == "Setup_LEInput1":
          Setup.Setup_LEInput1(Driver1.Value[6], Driver1.Value[7], Driver1.Value[8], Driver1.Value[9])
          
        if Driver.Value[i] == "Setup_LEInput1Extend":
          Setup.Setup_LEInput1(Driver1.Value[25], Driver1.Value[26], Driver1.Value[27], Driver1.Value[28])
        if Driver.Value[i] == "Setup_LELinkBlob":
          Setup.Setup_LELinkBlob()
        if Driver.Value[i] == "Setup_LELinkImage":
          Setup.Setup_LELinkImage()
        if Driver.Value[i] == "Setup_LELinkImageList":  
          Setup.Setup_LELinkImageList()
        if Driver.Value[i] == "Setup_LELinkRunCountList":  
          Setup.Setup_LELinkRunCountList()
 
         
        if Driver.Value[i] == "Setup_LELinkOCRFontLB":
          Setup.Setup_LELinkOCRFontLB()
          
        if Driver.Value[i] == "Setup_LELinkOCRFieldDefinition":
          Setup.Setup_LELinkOCRFieldDefinition()
          
        if Driver.Value[i] == "Setup_LELinkOCRVerificationParams":
          Setup.Setup_LELinkOCRVerificationParams()

        if Driver.Value[i] == "Setup_LELinkOCRSpaceModel":
          Setup.Setup_LELinkOCRSpaceModel()
          
        if Driver.Value[i] == "Setup_LELinkPort":
          c = Driver1.Value[10]
          Setup.Setup_LELinkPort(c)
          
        if Driver.Value[i] == "Setup_LELinkPatternModelList":
          #c = Driver1.Value[10]
          Setup.Setup_LELinkPatternModelList()
          
        if Driver.Value[i] == "Setup_LELinkPort1":
          c = Driver1.Value[22]
          Setup.Setup_LELinkPort(c)
        if Driver.Value[i] == "Setup_LELinkLEResults":
          c = Driver1.Value[22]
          Setup.Setup_LELinkLEResults(c)
          
        if Driver.Value[i] == "Setup_LEInput2":
          Setup.Setup_LEInput2(Driver1.Value[11], Driver1.Value[12], Driver1.Value[13])
          
        if Driver.Value[i] == "Setup_LEInput2Extend":
          Setup.Setup_LEInput2(Driver1.Value[29], Driver1.Value[30], Driver1.Value[31])

        if Driver.Value[i] == "Setup_LEInputByPreferenceProperty":
          Setup.Setup_LEInputByPreferenceProperty(str(Driver1.Value[32]).strip('""'))

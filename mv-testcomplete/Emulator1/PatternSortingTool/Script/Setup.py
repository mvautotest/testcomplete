...
def Setup_VPMOCRFontLibraryTabRunMode():
  Aliases.javaw.VpmFrame.RootPane.null_layeredPane.null_contentPane.VPM.HideableTabbedPane2.DisplayPanel.DisplayPanel_DisplayPanelRightPanel_.SplitPane.DisplayPanel_ImagePane.ClickTab("Advanced OCR: OCR Font Library")
...
def Setup_DragOCRFontLibraryToCpFile():
  Aliases.javaw.CpmFrame3.RootPane.null_layeredPane.null_contentPane.Panel.SplitPane.ApplicationPane.VisionProgramPanel.SplitPane.SplitPane.CPMPatchPanel.TasksTabbedPane.TasksTabbedPane_TaskComponent_.Panel.ScrollPane.Viewport.TasksTabbedPane_TaskTree_.DblClickItem("Root|Image In Task|Advanced OCR")
  Delay(1000)
  Aliases.javaw.CpmFrame3.RootPane.null_layeredPane.null_contentPane.Panel.SplitPane.ApplicationPane.VisionProgramPanel.SplitPane.SplitPane.CPMPatchPanel.TasksTabbedPane.TasksTabbedPane_TaskComponent_.Panel.ScrollPane.Viewport.TasksTabbedPane_TaskTree_.ClickItemR("Root|Image In Task|Advanced OCR|OCR Font Library")
...
def Setup_LinkOCRFontLibrary():
  ...
  scrollPane.Viewport.CustomSplitPane.TasksTabbedPane_FilledLayeredPane_.TaskTree.ClickItem("Root|Image In Task|Advanced OCR|OCR Font Library")

#Author: Ha Le
#The test verify all trained mode display when clicking on Mode used button
#Note: Cannot add checkpoint to verify the trained mode after clicking to mode use button
